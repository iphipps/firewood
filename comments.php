	...
	<div class="comments-template">
		...
		<?php if ( have_comments() ) : ?>
			...
			<div class="comments">
				...
				<h3 class="comments-header"><?php comments_number( sprintf( __( 'No responses to %1$s', 'firewood' ), the_title( '&#8220;', '&#8221;', false ) ), sprintf( __( 'One response to %1$s', 'firewood' ), the_title( '&#8220;', '&#8221;', false ) ), sprintf( __( '%1$s responses to %2$s', 'firewood' ), '%', the_title( '&#8220;', '&#8221;', false ) ) ); ?></h3>
